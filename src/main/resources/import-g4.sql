-- P9: full populateDB-derived H2 seed for Owner/Pet (+Visit) body canon
-- Source: legacy src/main/resources/db/hsqldb/populateDB.sql
...
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (3, 'Rosy', DATE '2011-04-17', 2, 3);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (4, 'Jewel', DATE '2010-03-07', 2, 3);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (5, 'Iggy', DATE '2010-11-30', 3, 4);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (6, 'George', DATE '2010-01-20', 4, 5);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (7, 'Samantha', DATE '2012-09-04', 1, 6);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (8, 'Max', DATE '2012-09-04', 1, 6);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (9, 'Lucky', DATE '2011-08-06', 5, 7);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (10, 'Mulligan', DATE '2007-02-24', 2, 8);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (11, 'Freddy', DATE '2010-03-09', 5, 9);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (12, 'Lucky', DATE '2010-06-24', 2, 10);
INSERT INTO pets (id, name, birth_date, type_id, owner_id) VALUES (13, 'Sly', DATE '2012-06-08', 1, 10);
INSERT INTO visits (id, pet_id, visit_date, description) VALUES (1, 7, DATE '2013-01-01', 'rabies shot');
INSERT INTO visits (id, pet_id, visit_date, description) VALUES (2, 8, DATE '2013-01-02', 'rabies shot');
INSERT INTO visits (id, pet_id, visit_date, description) VALUES (3, 8, DATE '2013-01-03', 'neutered');
INSERT INTO visits (id, pet_id, visit_date, description) VALUES (4, 7, DATE '2013-01-04', 'spayed');
